document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ru: {
            ...
            proj2_description: "Создание личного сайта-портфолио для демонстрации навыков и проектов. Реализована темная/светлая тема, многоязычность и плавные анимации.",
        ...
        en: {
            ...
            proj2_description: "Creation of a personal portfolio website to showcase skills and projects. Implemented a dark/light theme, multilingual support, and smooth animations.",
            proj2_tech: "Flutter, Dart",
            proj3_title: "Sonus Music",
        ...
        tk: {
            page_title: "Ataýew Kemal - Portfel",
            nav_home: "Baş sahypa",
            ...
            proj1_tech: "PHP, Laravel, Javascript, Bootstrap, Blade, MySql/SQL, AJAX, Jquery, Chart.js, API, Postman",
            proj2_title: "Aura Kompýuter App",
            proj2_description: "Başarnyklary we taslamalary görkezmek üçin şahsy portfel web sahypasynyň döredilmegi. Gije/gündiz temasy, köp dilli goldaw we üznüksiz animasiýalar durmuşa geçirildi.",
            proj2_tech: "Flutter, Dart",
            proj3_title: "Sonus Music",
